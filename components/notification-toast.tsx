...
const TYPE_CONFIG: Record<string, { icon: string; accent: string; glow: string; border: string; iconBg: string; progressBar: string }> = {
    ...
    expense_refund_confirmed: { icon: '💸', accent: 'from-cyan-400 to-sky-400', glow: 'shadow-cyan-400/25', border: '#0891b2', iconBg: 'bg-cyan-100 dark:bg-cyan-900/50', progressBar: 'from-cyan-400 to-sky-400' },
