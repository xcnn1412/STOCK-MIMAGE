...
| 2 | Tracer bullet: ใบเสนอราคา ร่าง → ส่ง → อนุมัติ → ได้เลข | 1 | [x] 2026-08-27 — ฟอร์ม generic ทุกประเภท + ปุ่ม transition ครบ (รวม void/sent/close ของ ticket 10 แล้ว) |
| 3 | รายการเอกสาร: ค้นหา ตัวกรอง สิทธิ์การมองเห็น | 2 | [ ] |
| 4 | PDF ใบเสนอราคา (layout การเงิน) | 2 | [ ] |
| 5 | ตั้งค่าแบรนด์ + ตัวนับ | 1 | [x] 2026-08-27 — settings/actions.ts แยกไฟล์, ล็อกรหัสหลังออกเลข, กันลด last_number ต่ำกว่าเลขที่ออกแล้ว |
