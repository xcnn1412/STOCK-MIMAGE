...
const en: Dictionary = {
  ...
  crm: {
    ...
    addLead: {
      ...
      customerType: 'Booth Type',
      customerTypePlaceholder: 'Select booth',
      channel: 'Channel',
      ...
      packagePlaceholder: 'Select service system',
    ...
    detail: {
      ...
      financial: 'Financial',
      package: 'Service System',
      selectPackage: 'Select service system',
      quotedPrice: 'Quoted Price',
    ...
    settings: {
      ...
      packages: '📦 Service Systems',
      customerTypes: '👥 Booth Types',
