...
export const dictionary = {
  en: {
    ...
    events: {
      ...
      canCloseDirectly: 'You can close this event now.',
      delete: 'Delete Event',
  ...
  th: {
    nav: {
      ...
      kpi: 'ประเมิน KPI',
      costs: 'ต้นทุน',
      costsDashboard: 'แดชบอร์ด',
      costsImport: 'นำเข้า',
      costsEvents: 'รายการงาน',
      costsReports: 'รายงาน',
      ...
      salaryMySlips: 'สลิปของฉัน',
      salaryRuns: 'งวดคำนวณ',
      salarySettings: 'ตั้งค่า',
    ...
    events: {
      ...
      canCloseDirectly: 'คุณสามารถปิดงานอีเวนต์นี้ได้ทันที',
      delete: 'ลบอีเวนต์',
